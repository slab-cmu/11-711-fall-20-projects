...
from mynlplib import coref_learning, neural_net, coref
from mynlplib.coref_features import minimal_features
from mynlplib.coref_learning import FFCoref
from mynlplib.coref import Markable
from mynlplib.utils import initialize_with_pretrained, UNK_TOKEN
from mynlplib.neural_net import BiLSTMWordEmbedding, AttentionBasedMarkableEmbedding, SequentialScorer
...
def test_bilstm_embedding_d4_1():
    ...
    true_not = [-0.1936897188425064,
                -0.14047981798648834,
                -0.05897653475403786,
                0.018729249015450478,
                0.1447497457265854,
                -0.22198791801929474]
