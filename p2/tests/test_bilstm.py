...
def test_dlmodel_forward():
    ...
    assert_almost_equal(lstm_feats[0].data.numpy()[0],0.044214, places=4)
    assert_almost_equal(lstm_feats[0].data.numpy()[1],-0.071416, places=4)
    assert_almost_equal(lstm_feats[0].data.numpy()[2],-0.125279, places=4)
